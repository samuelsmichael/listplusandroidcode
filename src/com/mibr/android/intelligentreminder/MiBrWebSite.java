...
public class MiBrWebSite extends Activity {
	@Override
...
//			.loadUrl("http://www.ibm.com");
				.loadUrl("http://www.cellularassistant.com/intelligentreminder/default.aspx");
		// webview.loadUrl("http://www.cellularassistant.com/intelligentreminder/default.aspx");
*/		

		Uri uri = Uri.parse("http://www.cellularassistant.com/intelligentreminder/default.aspx");
